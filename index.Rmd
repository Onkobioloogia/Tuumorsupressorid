...
```{r, out.width = 300, fig.cap="A New Theory on the Cancer-inducing Mechanism"}
knitr::include_graphics("assets/img/Nordling1953.png")
```

*"..several successive mutations in the same cell, probabably about seven in the case of human cancer, would be necessary.."*
]

.footer[C.O. Nordling. [A New Theory on the Cancer-inducing Mechanism](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC2007872/?page=1). Br J Cancer. Mar 1953; 7(1): 68–72.]
...
```{r, out.width = 200, fig.cap="A.Knudson"}
knitr::include_graphics("http://upload.wikimedia.org/wikipedia/commons/9/94/Nci-vol-8196-300_alfred_knudson.jpg")
```
]

.footer[Foto:wikpedia.]
